...
For many of the question types, plot colors can be changed via the `spectrumInput` widget from [dreamRs/shinyWidgets](https://shinyapps.dreamrs.fr/shinyWidgets/). 
