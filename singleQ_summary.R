...
# 
# # Rank Order (RO)
rankorder <- function(q, meta, color) {
...
# 
# # Matrix (Matrix)
matrix_q <- function(q, meta, color) {
...
# 
# # Pick Group Rank (PGR)
pickgrouprank <- function(q, meta, color) {
...
# 
# # DrillDown (DD)
drilldown <- function(q, meta, color) {
